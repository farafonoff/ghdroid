 ...
 * lead to a {@link RepositoryDetailActivity} representing
 * item details. On tablets, the activity presents the list of items and
 * item details side-by-side using two vertical panes.
 * <p/>
 * The activity makes heavy use of fragments. The list of items is a
 * {@link RepositoryListFragment} and the item details
 * (if present) is a {@link RepositoryDetailFragment}.
 * <p/>
...
public class RepositoryListActivity extends FragmentActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (findViewById(R.id.repository_detail_container) != null) {
            ...
            ((RepositoryListFragment) getSupportFragmentManager()
    ...
    public void onItemSelected(String id) {
        if (mTwoPane) {
            ...
            arguments.putString(RepositoryDetailFragment.ARG_ITEM_ID, id);
